...
class GradCAM(object):
    ...
    def __init__(self, model_dict, verbose=False):
        ...
        if 'vgg' in model_type.lower():
            ...
            target_layer = find_alexnet_layer(self.model, layer_name)
        elif 'squeezenet' in model_type.lower():
            target_layer = find_squeezenet_layer(self.model, layer_name)
...
#   author is this guy: https://github.com/1Konny/gradcam_plus_plus-pytorch
#                            
##########################################################################
...
def find_resnet_layer(model, target_layer_name):
    """Find resnet layer to calculate GradCAM and GradCAM++
    
    Args:
        model: default torchvision densenet models
    ...
    if 'layer' in target_layer_name:
        ...
        if layer_num == 1:
            ...
            target_layer = model.lbackbone.ayer3
        elif layer_num == 4:
        ...
        target_layer = model._modules[target_layer_name]
